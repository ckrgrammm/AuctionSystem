                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="signup.html">Register</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form class="l-f-o__form" action="signup.php" method="POST">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text" id="reg-fname" name="firstName" placeholder="First Name"></div>
                                            <div class="u-s-m-b-30">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="number" id="reg-lname" placeholder="Contact Number"></div>
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text" id="reg-email" name="email" placeholder="Enter E-mail"></div>
                                            <div class="u-s-m-b-30">
