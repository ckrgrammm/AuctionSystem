    ...
    function createProductCard(product) {
        ...
        const productCard = `
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="product-m">
                    <div class="product-m__thumb">
                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.php?productId=${product.id}">
                    ...
                    <div class="product-m__content">
                        ...
                        <div class="product-m__name">
                            <a href="product-detail.php?productId=${product.id}">${product.title}</a>
                        </div>
